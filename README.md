...
SAP NCo 原生库依赖 **Microsoft Visual C++ 2022 可再发行程序包**。如果运行环境中尚未安装，请下载并安装 x64 版本：

- **下载地址**：<https://aka.ms/vc14/vc_redist.x64.exe>
- **版本说明**：<https://learn.microsoft.com/zh-cn/cpp/windows/latest-supported-vc-redist?view=msvc-170>

> VC++ v14 可再发行程序包为 Visual Studio 2017–2026 共用，安装最新版本即可满足要求。
